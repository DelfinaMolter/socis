...
const ISO_STANDARDS = [
  ...
  },
  {
    ...
    name: "ISO 22000",
    desc: "Sistemas de Gestión de Seguridad Alimentaria que unifica los requerimientos del sector basado en los distintos estándares internacionales del rubro alimentario.",
  },
  {
    category: "SEGURIDAD DE LA INFORMACIÓN",
    name: "ISO 27001",
    desc: "Describe cómo gestionar la seguridad de la información en una empresa. El eje central es proteger la confidencialidad, integridad y disponibilidad de la información en una empresa.",
  },
  {
    category: "EQUIPOS MÉDICOS",
    name: "ISO 13485",
    desc: "Sistema de gestión de la calidad reconocido internacionalmente para fabricantes de equipos médicos y servicios relacionados.",
  },
  {
  ...
  },
  {
    ...
    name: "IRAM 3546",
    desc: "Normativa que establece los requisitos que deben cumplir las empresas para la inspección, prueba y mantenimiento de instalaciones contra incendio.",
  },
];
                  ...
                  <div className="max-w-4xl mx-auto space-y-12">
                    <div className="text-center">
                      ...
                      <div className="inline-block px-4 py-2 bg-red-50 text-red-600 rounded-lg font-bold text-sm border border-red-100">
                        Vigencia: 1° de Enero de 2020 hasta el 31 de Diciembre
                        de 2029
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-12 gap-10 items-start">
                      ...
                      <div className="md:col-span-8 space-y-8">
                        ...
                        <div className="pt-4 text-xs text-slate-400 italic">
                          ...
                          Industria del Software podrán continuar con el nuevo
                          régimen ajustándose a las nuevas reglamentaciones.
                        </div>
                      </div>
                    </div>
                  </div>
